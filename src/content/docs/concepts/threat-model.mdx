...
```shell
warning: decrypting in non-interactive terminal; for better security, configure GPG to require passphrase entry (https://dotsecenv.com/docs/concepts/threat-model#automated-secret-exfiltration)
```

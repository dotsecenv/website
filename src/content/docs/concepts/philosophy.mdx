...
<Aside type="note">
  age is an excellent tool for its use case (simple file encryption). It's not a
  criticism—it's a deliberate design choice by age's creators to omit signing
  for simplicity.
</Aside>

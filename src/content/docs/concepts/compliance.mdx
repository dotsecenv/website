...
- **Deterministic behavior** — Runtime behavior is reproducible across builds
- **Compliance evidence** — Auditors can verify the exact module version used
- **Validated code path** — The binary uses a cryptographic implementation derived from the Go FIPS module awarded certificate A6650
...
<Aside type="tip">
For maximum compliance, build dotsecenv with Go 1.24+ and `GOFIPS140=v1.26.0`, deploy to a validated Operating Environment, and use Ed25519 or RSA-4096 keys.
</Aside>

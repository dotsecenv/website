...
<Aside type="tip">
For most users, the [Quickstart](/tutorials/quickstart/) handles installation automatically. This page is a reference for all installation methods and options.
</Aside>

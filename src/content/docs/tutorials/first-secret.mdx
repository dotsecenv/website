...
<Aside type="tip">
New to dotsecenv? Start with the [Quickstart](/tutorials/quickstart/) for the fastest path. This tutorial covers advanced topics like namespaces and `.secenv` file syntax.
</Aside>
...
5. **Create a `.secenv` file**
   ...
   - `VAR={dotsecenv/}` — Same as above (trailing slash ignored)

...
1. **Install dotsecenv**
   ...
   <Tabs>
     <TabItem label="Install Script">
       ...
       This auto-detects your platform, verifies checksums, and installs the binary, shell completions, man pages, and shell plugin. See the [installation tutorial](/tutorials/installation/) for all options.
     </TabItem>

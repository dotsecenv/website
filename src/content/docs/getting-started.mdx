...
1. **Install dotsecenv**
   ...
   <Tabs>
     <TabItem label="Install Script">
       ...
       This auto-detects your platform, verifies checksums, and installs the binary, shell completions, man pages, and shell plugin to your home directory by default (no sudo needed). Use `--system` for system-wide paths. See the [installation tutorial](/tutorials/installation/) for all options.
     </TabItem>

...
<div style="display: flex; flex-wrap: wrap; gap: 4px;">
  <a href="https://github.com/dotsecenv/dotsecenv/actions/workflows/ci.yml">
    <img
      src="https://github.com/dotsecenv/dotsecenv/actions/workflows/ci.yml/badge.svg"
      alt="CI"
    />
  </a>
  <a href="https://github.com/dotsecenv/dotsecenv/actions/workflows/release.yml">
    <img
      src="https://github.com/dotsecenv/dotsecenv/actions/workflows/release.yml/badge.svg"
      alt="Release"
    />
  </a>
  <a href="https://github.com/dotsecenv/dotsecenv/actions/workflows/action-e2e.yml">
    <img
      src="https://github.com/dotsecenv/dotsecenv/actions/workflows/action-e2e.yml/badge.svg"
      alt="GitHub Action E2E"
    />
  </a>
  <a href="https://github.com/dotsecenv/dotsecenv/actions/workflows/hermetic-e2e.yml">
    <img
      src="https://github.com/dotsecenv/dotsecenv/actions/workflows/hermetic-e2e.yml/badge.svg"
      alt="Hermetic E2E"
    />
  </a>
  <a href="https://github.com/dotsecenv/packages/actions/workflows/publish.yml">
    <img
      src="https://github.com/dotsecenv/packages/actions/workflows/publish.yml/badge.svg"
      alt="Publish Packages"
    />
  </a>
  <a href="https://github.com/dotsecenv/homebrew-tap/actions/workflows/post-release.yml">
    <img
      src="https://github.com/dotsecenv/homebrew-tap/actions/workflows/post-release.yml/badge.svg"
      alt="Homebrew install"
    />
  </a>
  <a href="https://github.com/dotsecenv/plugin/actions/workflows/ci.yml">
    <img
      src="https://github.com/dotsecenv/plugin/actions/workflows/ci.yml/badge.svg"
      alt="Shell plugins CI"
    />
  </a>
  <a href="https://github.com/dotsecenv/website/actions/workflows/deploy-website.yml">
    <img
      src="https://github.com/dotsecenv/website/actions/workflows/deploy-website.yml/badge.svg"
      alt="Publish Website"
    />
  </a>
</div>
...
echo "your-secret-key" | dotsecenv secret store AWS_SECRET_ACCESS_KEY
...
<CardGrid>
  ...
  <Card title="No data collection" icon="approve-check">
    No telemetry, no call-home features. Your secrets stay yours. Tested with{" "}
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Detailed platform-specific instructions"
    href="/tutorials/installation/"
  />
  <LinkCard
    title="Security Model"
    description="Understand how dotsecenv protects your secrets"
